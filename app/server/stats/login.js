Hooks.onLoggedIn = function (userId) {
  ...
  } else if(Meteor.user().services && Meteor.user().services.facebook && Meteor.user().services.facebook.name && Meteor.user().profile.name != Meteor.user().services.facebook.name) {
